...
results = (reduce(hcat, r[1:end])')
results[:, 2] = results[:, 2] ./ n

contagion_plot = plot(results[1:11], [results[12:22], results[23:end]],
...
contagion_freq = plot(results[:,1], [results[:,3], results[:,2] ./ n],
  label=["Extent of contagion" "Frequency of contagion"])
plot!(legend=:outerbottom, legendcolumns=1)

savefig(contagion_freq, "research_proposal/contagion_freq1.png")

plot([0.204, 0.2, 0.24, 0.174, 0.202, 0.222, 0.222, 0.252, 0.242, 0.27, 0.278, 0.256, 0.266, 0.254, 0.262, 0.254])
